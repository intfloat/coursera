    ...
    case e of
      ...
      | Shift(dx, dy, e1) => 
          ...
          in (case res of
             ...
             | _ => raise Impossible "impossible cases")
          end)
...
fun preprocess_prog (e) =
  case e of
       LineSegment(x1, y1, x2, y2) =>
            ...
            else if (x1-x2)>epsilon then LineSegment(x2, y2, x1, y1)
            else if real_close(x1, x2) andalso (y1-y2)>epsilon
