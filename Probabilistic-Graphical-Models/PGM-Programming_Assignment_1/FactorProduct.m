...
for i = 1: prod(C.card),
    a = GetValueOfAssignment(A, IndexToAssignment(indxA(i), A.card)) ;
    b = GetValueOfAssignment(B, IndexToAssignment(indxB(i), B.card)) ;
    C.val(i) = a*b ;
    % C = SetValueOfAssignment(C, IndexToAssignment(i, C.card), a*b) ;
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
